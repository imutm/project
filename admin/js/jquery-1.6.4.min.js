  ...
  f.fn.extend({
              ...
              : ((l = ck.exec(h)),
                ...
                l
                  ? ((n = parseFloat(l[2])),
                    ...
                    o !== "px" && (f.style(this, i, (n || 1) + o), (m = ((n || 1) / k.cur()) * m), f.style(this, i, m + o)),
                    l[1] && (n = (l[1] === "-=" ? -1 : 1) * n + m),
                    k.custom(m, n, o))
                  : k.custom(m, h, ""));
        return !0;
    ...
    (f.fx.prototype = {
      ...
      step: function (a) {
        ...
        e.duration == Infinity
          ? (this.now = b)
          : ((h = b - this.startTime), (this.state = h / e.duration), (this.pos = f.easing[e.animatedProperties[this.prop]](this.state, h, 0, 1, e.duration)), (this.now = this.start + (this.end - this.start) * this.pos)),
          this.update();
        return !0;
      },
    }),
  ...
  "getBoundingClientRect" in c.documentElement
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
          ...
          (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ((l += b.offsetTop),
              (m += b.offsetLeft),
              f.offset.doesNotAddBorder && (!f.offset.doesAddBorderForTableAndCells || !cs.test(b.nodeName)) && ((l += parseFloat(c.borderTopWidth) || 0), (m += parseFloat(c.borderLeftWidth) || 0)),
              (e = d),
              (d = b.offsetParent)),
    ...
    (f.offset = {
      initialize: function () {
        ...
        f.extend(b.style, { position: "absolute", top: 0, left: 0, margin: 0, border: 0, width: "1px", height: "1px", visibility: "hidden" }),
          (b.innerHTML = j),
