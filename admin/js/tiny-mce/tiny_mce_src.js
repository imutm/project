    ...
    ed.onKeyDown.add(function (ed, e) {
      ...
      if (isDelete || e.keyCode == BACKSPACE) {
        ...
        if (blockElm) {
          ...
          while (node.nodeType == 3 && node.nodeValue.length == 0) node = node.nextSibling;
...
(function (tinymce) {
  ...
  function unpack(lookup, data) {
    ...
    replace(data)
      .replace(/#/g, "#text")
      .replace(/(\w+)\[([^\]]+)\]\[([^\]]*)\]/g, function (str, name, attributes, children) {
    ...
    self.parse = function (html) {
      ...
      while ((matches = tokenRegExp.exec(html))) {
        ...
        if ((value = matches[6])) {
          ...
          if (!isShortEnded) {
            if (!attribsValue || attribsValue.indexOf("/") != attribsValue.length - 1) stack.push({ name: value, valid: isValidElement });
      ...
      for (ni = 0; ni < nodes.length; ni++) {
        ...
        if (parent && parents.length > 1) {
          ...
          if (schema.isValidChild(node.parent.name, "div") && schema.isValidChild("div", node.name)) {
            ...
            if (node.name === "style" || node.name === "script") node.empty().remove();
            else node.unwrap();
          }
        }
      }
            ...
            if (elementRule) {
              ...
              if (elementRule.removeEmpty || elementRule.paddEmpty) {
                if (node.isEmpty(nonEmptyElements)) {
                  if (elementRule.paddEmpty) node.empty().append(new Node("#text", "3")).value = "\u00a0";
                  else {
            ...
            if (node) {
              ...
              if (parent.isEmpty(nonEmptyElements)) {
                ...
                if (elementRule) {
                  ...
                  else if (elementRule.paddEmpty) parent.empty().append(new tinymce.html.Node("#text", 3)).value = "\u00a0";
                }
              }
            }
          }
  ...
  tinymce.create("tinymce.dom.DOMUtils", {
      ...
      return this.run(node, function (node) {
        ...
        if (keep_children) {
          while ((child = node.firstChild)) {
            ...
            if (!tinymce.isIE || child.nodeType !== 3 || child.nodeValue) parent.insertBefore(child, node);
    ...
    getAttribs: function (n) {
      ...
      if (isIE) {
        ...
        if (n.nodeName === "OPTION" && this.getAttrib(n, "selected")) o.push({ specified: 1, nodeName: "selected" });

        // It's crazy that this is faster in IE but it's because it returns all attributes all the time
        n.cloneNode(false)
          .outerHTML.replace(/<\/?[\w:\-]+ ?|=[\"][^\"]+\"|=\'[^\']+\'|=[\w\-]+|>/gi, "")
      ...
      function trim(node) {
        ...
        if (type != 9) {
          ...
          if (type == 3 && node.nodeValue.length > 0) {
            ...
            children = node.childNodes;
            if (children.length == 1 && children[0] && children[0].nodeType == 1 && children[0].getAttribute("data-mce-type") == "bookmark") node.parentNode.insertBefore(children[0], node);
  ...
  function Selection(selection) {
    ...
    function getRange() {
      ...
      function findEndPoint(start) {
        ...
        if (endPoint.position < 0) {
          ...
          if (!offset) {
            if (sibling.nodeType == 3) domRange[start ? "setStart" : "setEnd"](sibling, 0);
          ...
          if (!offset) {
            if (container.nodeType == 3) domRange[start ? "setStart" : "setEnd"](sibling, container.nodeValue.length);
    ...
    this.getBookmark = function (type) {
      ...
      if (type === 2) {
        ...
        } else bookmark.start = { ctrl: true, indexes: getIndexes(rng.item(0)) };
      }
  ...
  tinymce.create("tinymce.dom.Selection", {
    ...
    getBookmark: function (type, normalized) {
      ...
      if (type == 2) {
        function getLocation() {
          ...
          function getPoint(rng, start) {
            ...
            if (container.nodeType == 3) {
              if (normalized) {
                for (node = container.previousSibling; node && node.nodeType == 3; node = node.previousSibling) offset += node.nodeValue.length;
              }
      ...
      if (rng.duplicate || rng.item) {
        ...
        element = t.getNode();
        name = element.nodeName;
        if (name == "IMG") return { name: name, index: findIndex(name, element) };
      ...
      function selectionChange(e) {
        ...
        if (e.button) {
          ...
          if (pointRng) {
            ...
            if (pointRng.compareEndPoints("StartToStart", startRng) > 0) pointRng.setEndPoint("StartToStart", startRng);
  ...
  tinymce.dom.Serializer = function (settings, dom, schema) {
    ...
    htmlParser.addAttributeFilter("src,href,style", function (nodes, name) {
      ...
      while (i--) {
        ...
        if (value !== undef) {
          ...
          if (name === "style") value = dom.serializeStyle(dom.parseStyle(value), node.name);
          else if (urlConverter) value = urlConverter.call(urlConverterScope, value, name, node.name);
    ...
    return {
      ...
      serialize: function (node, args) {
        ...
        args.content = htmlSerializer.serialize(htmlParser.parse(args.getInner ? node.innerHTML : tinymce.trim(dom.getOuterHTML(node), args), args));
...
(function (tinymce) {
  tinymce.dom.RangeUtils = function (dom) {
    ...
    this.walk = function (rng, callback) {
      ...
      if (endContainer.nodeType == 1 && endContainer.hasChildNodes()) endContainer = endContainer.childNodes[Math.min(endOffset - 1, endContainer.childNodes.length - 1)];
  ...
  tinymce.create("tinymce.ui.Button:tinymce.ui.Control", {
    ...
    renderHTML: function () {
      ...
      h =
        ...
        DOM.encode(s.title) +
        '">';
      if (s.image && !(this.editor && this.editor.forcedHighContrastMode)) h += '<img class="mceIcon" src="' + s.image + '" alt="' + DOM.encode(s.title) + '" />' + l;
      else h += '<span class="mceIcon ' + s["class"] + '"></span>' + (l ? '<span class="' + cp + 'Label">' + l + "</span>" : "");
  ...
  tinymce.create("tinymce.ui.ListBox:tinymce.ui.Control", {
    ...
    renderHTML: function () {
      ...
      h +=
        ...
        DOM.createHTML(
          "a",
          { id: t.id + "_open", tabindex: -1, href: "javascript:;", class: "mceOpen", onclick: "return false;", onmousedown: "return false;" },
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.ui.SplitButton:tinymce.ui.MenuButton", {
    ...
    renderHTML: function () {
      ...
      if (s.image) h1 = DOM.createHTML("img ", { src: s.image, role: "presentation", class: "mceAction " + s["class"] });
      else h1 = DOM.createHTML("span", { class: "mceAction " + s["class"] }, "");

      h1 += DOM.createHTML("span", { class: "mceVoiceLabel mceIconOnly", id: t.id + "_voice", style: "display:none;" }, s.title);
      h +=
        "<td >" + DOM.createHTML("a", { role: "button", id: t.id + "_action", tabindex: "-1", href: "javascript:;", class: "mceAction " + s["class"], onclick: "return false;", onmousedown: "return false;", title: s.title }, h1) + "</td>";
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.Editor", {
    ...
    init: function () {
      ...
      if (s.ie7_compat) t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=7" />';
      else t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=edge" />';
      ...
      t.parser.addAttributeFilter("src,href,style", function (nodes, name) {
        ...
        while (i--) {
          ...
          if (!node.attributes.map[internalName]) {
            if (name === "style") node.attr(internalName, dom.serializeStyle(dom.parseStyle(value), node.name));
      ...
      if (isGecko) {
        ...
        function fixLinks(ed, o) {
          each(ed.dom.select("a"), function (n) {
            ...
            if (ed.dom.isBlock(pn) && pn.lastChild === n) ed.dom.add(pn, "br", { "data-mce-bogus": 1 });
          });
        }
    ...
    setContent: function (content, args) {
      ...
      if (!tinymce.isIE && (content.length === 0 || /^\s+$/.test(content))) {
        ...
        if (forcedRootBlockName) content = "<" + forcedRootBlockName + '><br data-mce-bogus="1"></' + forcedRootBlockName + ">";
    ...
    _addEvents: function () {
      ...
      t.onKeyDown.add(function (ed, e) {
        ...
        while (n && n.nodeType && n.nodeType != 1 && n.parentNode) n = n.parentNode;
    ...
    addCommands({
      ...
      mceInsertContent: function (command, ui, value) {
        ...
        if (!args.invalid) {
          ...
          if (!node || (node === node2 && node.nodeName === "BR")) dom.setHTML(parentNode, value);
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.ForceBlocks", {
    ...
    insertPara: function (e) {
      ...
      if (/^(H[1-6])$/.test(bn) && isAtEnd(r, sb)) aft = ed.dom.create(se.element);
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.ControlManager", {
    ...
    createListBox: function (id, s, cc) {
      ...
      if (ed.settings.use_native_selects || useNativeListForAccessibility(ed)) c = new tinymce.ui.NativeListBox(id, s);
      else {
...
(function (tinymce) {
  tinymce.Formatter = function (ed) {
      ...
      if (name) {
        if (typeof name !== "string") {
          ...
          each(format, function (format) {
            ...
            // Default to true
            if (format.split === undefined) format.split = !format.selector || format.inline;

            // Default to true
            if (format.remove === undefined && format.selector && !format.inline) format.remove = "none";
    ...
    function toggle(name, vars, node) {
      ...
      if (match(name, vars, node) && (!("toggle" in fmt[0]) || fmt[0]["toggle"])) remove(name, vars, node);
          ...
          if (items.length === undefined) {
            for (key in items) {
              if (items.hasOwnProperty(key)) {
                if (item_name === "attributes") value = dom.getAttrib(node, key);
    ...
    function getStyle(node, name) {
      ...
      if (name == "color" || name == "backgroundColor") styleVal = dom.toHex(styleVal);
    ...
    function expandRng(rng, format, remove) {
      ...
      if (format[0].inline) {
        ...
        if (leaf.node) {
          while (leaf.node && leaf.offset === 0 && leaf.node.previousSibling) leaf = findLeaf(leaf.node.previousSibling);
      ...
      if (format[0].block || format[0].selector) {
        function findBlockEndPoint(container, sibling_name, sibling_name2) {
          ...
          if (!node) node = dom.getParent(container.nodeType == 3 ? container.parentNode : container, isBlock);
              ...
              if (hasPending() && !tinymce.dom.RangeUtils.compareRanges(pendingFormats.lastRng, selection.getRng())) {
                ...
                each(dom.select("font,span"), function (node) {
                  ...
                  if (isCaretNode(node)) {
                    ...
                    while (textNode && textNode.nodeType != 3) textNode = textNode.firstChild;
