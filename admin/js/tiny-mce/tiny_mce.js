  ...
  d.create("tinymce.ui.ListBox:tinymce.ui.Control", {
    ...
    renderHTML: function () {
      ...
      i +=
        ...
        c.createHTML(
          "a",
          { id: f.id + "_open", tabindex: -1, href: "javascript:;", class: "mceOpen", onclick: "return false;", onmousedown: "return false;" },
...
(function (a) {
  ...
  a.create("tinymce.ui.Toolbar:tinymce.ui.Container", {
    renderHTML: function () {
      ...
      return c.createHTML(
        "table",
        { id: m.id, class: "mceToolbar" + (n["class"] ? " " + n["class"] : ""), cellpadding: "0", cellspacing: "0", align: m.settings.align || "", role: "presentation", tabindex: "-1" },
        "<tbody><tr>" + f + "</tr></tbody>"
      );
    },
  });
    ...
    u({
      ...
      mceInsertContent: function (B, I, K) {
        ...
        if (!G.invalid) {
          ...
          K = J.serialize(
            y.parse(
              K.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
